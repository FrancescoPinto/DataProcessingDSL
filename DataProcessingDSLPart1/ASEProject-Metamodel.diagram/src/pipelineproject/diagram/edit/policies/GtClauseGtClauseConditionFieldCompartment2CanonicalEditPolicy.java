 ...
 * @generated
 */
public class GtClauseGtClauseConditionFieldCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getGtClauseGtClauseConditionFieldCompartment_7112SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getGtClauseGtClauseConditionFieldCompartment_7112SemanticChildren((View) getHost().getModel());
