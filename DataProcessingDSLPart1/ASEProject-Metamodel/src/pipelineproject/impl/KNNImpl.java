 ...
 * </p>
 * <ul>
 *   <li>{@link pipelineproject.impl.KNNImpl#getK <em>K</em>}</li>
 * </ul>
 *
 * @generated
 */
public class KNNImpl extends ClassificationImpl implements KNN {
	/**
	...
	protected EClass eStaticClass() {
		return PipelineprojectPackage.Literals.KNN;
	}
	...
	public void setK(BigInteger newK) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PipelineprojectPackage.KNN__K, oldK, k));
	}
