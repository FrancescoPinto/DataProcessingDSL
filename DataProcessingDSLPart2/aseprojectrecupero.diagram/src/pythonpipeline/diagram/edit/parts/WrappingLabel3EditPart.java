...
public class WrappingLabel3EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(PythonpipelineVisualIDRegistry
				.getType(pythonpipeline.diagram.edit.parts.WrappingLabel3EditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PythonpipelineParserProvider.getParser(
					PythonpipelineElementTypes.InputSourceDeclarationSourceSchema_4005, getParserElement(),
