 ...
 * @generated
 */
public class ProjectOnAttributesIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ProjectOnAttributesIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineprojectParserProvider.getParser(PipelineprojectElementTypes.ProjectOnAttributes_2066,
					getParserElement(), PipelineprojectVisualIDRegistry
							.getType(pipelineproject.diagram.edit.parts.ProjectOnAttributesIdEditPart.VISUAL_ID));
		}
		return parser;
	}
