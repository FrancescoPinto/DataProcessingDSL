 ...
 * @generated
 */
public class JarvisPatrickJarvisPatrickRuntimeInfoCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getJarvisPatrickJarvisPatrickRuntimeInfoCompartment_7085SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getJarvisPatrickJarvisPatrickRuntimeInfoCompartment_7085SemanticChildren((View) getHost().getModel());
