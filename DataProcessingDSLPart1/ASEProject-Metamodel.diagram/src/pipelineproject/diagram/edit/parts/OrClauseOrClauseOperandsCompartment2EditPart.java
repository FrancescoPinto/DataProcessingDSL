...
import pipelineproject.diagram.edit.policies.OrClauseOrClauseOperandsCompartment2CanonicalEditPolicy;
import pipelineproject.diagram.edit.policies.OrClauseOrClauseOperandsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OrClauseOrClauseOperandsCompartment2EditPart extends ShapeCompartmentEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 7110;

	/**
	* @generated
	*/
	public OrClauseOrClauseOperandsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.OrClauseOrClauseOperandsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OrClauseOrClauseOperandsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(PipelineprojectVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new OrClauseOrClauseOperandsCompartment2CanonicalEditPolicy());
	}
