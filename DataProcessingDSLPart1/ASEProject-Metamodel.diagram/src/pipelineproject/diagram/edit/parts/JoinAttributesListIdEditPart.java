 ...
 * @generated
 */
public class JoinAttributesListIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public JoinAttributesListIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineprojectParserProvider.getParser(PipelineprojectElementTypes.JoinAttributesList_3067,
					getParserElement(), PipelineprojectVisualIDRegistry
							.getType(pipelineproject.diagram.edit.parts.JoinAttributesListIdEditPart.VISUAL_ID));
		}
		return parser;
	}
