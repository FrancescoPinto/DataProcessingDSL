 ...
 * </p>
 * <ul>
 *   <li>{@link pipelineproject.impl.NullValuesRemovalImpl#getPolicy <em>Policy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NullValuesRemovalImpl extends DataCleaningImpl implements NullValuesRemoval {
	 ...
	 * @ordered
	 */
	protected static final NulValuesPolicy POLICY_EDEFAULT = NulValuesPolicy.REGRESSION_IMPUTATION;
	...
	protected EClass eStaticClass() {
		return PipelineprojectPackage.Literals.NULL_VALUES_REMOVAL;
	}
	...
	public void setPolicy(NulValuesPolicy newPolicy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PipelineprojectPackage.NULL_VALUES_REMOVAL__POLICY, oldPolicy, policy));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PipelineprojectPackage.NULL_VALUES_REMOVAL__POLICY:
				return getPolicy();
		}
