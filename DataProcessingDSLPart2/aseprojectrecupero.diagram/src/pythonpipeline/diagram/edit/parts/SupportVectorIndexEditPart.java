 ...
 * @generated
 */
public class SupportVectorIndexEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SupportVectorIndexEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PythonpipelineParserProvider.getParser(PythonpipelineElementTypes.SupportVector_3035,
					getParserElement(), PythonpipelineVisualIDRegistry
							.getType(pythonpipeline.diagram.edit.parts.SupportVectorIndexEditPart.VISUAL_ID));
		}
		return parser;
	}
