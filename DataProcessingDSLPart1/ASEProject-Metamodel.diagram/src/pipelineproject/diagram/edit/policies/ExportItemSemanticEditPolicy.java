...
import pipelineproject.diagram.edit.commands.ExportWritesCreateCommand;
import pipelineproject.diagram.edit.commands.ExportWritesReorientCommand;
...
import pipelineproject.diagram.edit.parts.ExportExportRuntimeInfoCompartmentEditPart;
 ...
 * @generated
 */
public class ExportItemSemanticEditPolicy extends PipelineprojectBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ExportItemSemanticEditPolicy() {
		super(PipelineprojectElementTypes.Export_2056);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (PipelineprojectVisualIDRegistry.getVisualID(outgoingLink) == ExportWritesEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), outgoingLink));
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (PipelineprojectElementTypes.ExportWrites_4010 == req.getElementType()) {
			return getGEFWrapper(new ExportWritesCreateCommand(req, req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientReferenceRelationshipCommand(ReorientReferenceRelationshipRequest req) {
		...
		case ExportWritesEditPart.VISUAL_ID:
			return getGEFWrapper(new ExportWritesReorientCommand(req));
		}
