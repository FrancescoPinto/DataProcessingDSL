 ...
 * @generated
 */
public class OrClauseOrClauseOperandsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getOrClauseOrClauseOperandsCompartment_7110SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getOrClauseOrClauseOperandsCompartment_7110SemanticChildren((View) getHost().getModel());
