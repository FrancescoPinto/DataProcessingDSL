 ...
 * </p>
 * <ul>
 *   <li>{@link pipelineproject.impl.LogisticRegressionImpl#getEstimatedCoefficients <em>Estimated Coefficients</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LogisticRegressionImpl extends ClassificationImpl implements LogisticRegression {
	/**
	...
	protected EClass eStaticClass() {
		return PipelineprojectPackage.Literals.LOGISTIC_REGRESSION;
	}
	...
	public EList<BigDecimal> getEstimatedCoefficients() {
		if (estimatedCoefficients == null) {
			estimatedCoefficients = new EDataTypeUniqueEList<BigDecimal>(BigDecimal.class, this, PipelineprojectPackage.LOGISTIC_REGRESSION__ESTIMATED_COEFFICIENTS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PipelineprojectPackage.LOGISTIC_REGRESSION__ESTIMATED_COEFFICIENTS:
