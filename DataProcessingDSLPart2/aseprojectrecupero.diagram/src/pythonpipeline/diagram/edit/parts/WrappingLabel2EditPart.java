...
public class WrappingLabel2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(PythonpipelineVisualIDRegistry
				.getType(pythonpipeline.diagram.edit.parts.WrappingLabel2EditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PythonpipelineParserProvider.getParser(PythonpipelineElementTypes.TaskOutputSchema_4003,
