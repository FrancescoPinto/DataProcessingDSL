 ...
 * @generated
 */
public class ContainsClauseContainsClauseConditionFieldCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getContainsClauseContainsClauseConditionFieldCompartment_7107SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getContainsClauseContainsClauseConditionFieldCompartment_7107SemanticChildren(
