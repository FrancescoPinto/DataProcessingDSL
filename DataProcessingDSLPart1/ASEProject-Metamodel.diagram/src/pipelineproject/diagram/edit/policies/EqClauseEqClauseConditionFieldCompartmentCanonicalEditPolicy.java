 ...
 * @generated
 */
public class EqClauseEqClauseConditionFieldCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getEqClauseEqClauseConditionFieldCompartment_7104SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getEqClauseEqClauseConditionFieldCompartment_7104SemanticChildren((View) getHost().getModel());
