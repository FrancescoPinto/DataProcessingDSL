...
public class CustomCleaningCustomCleaningCustomParamsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PythonpipelinePackage.eINSTANCE.getCustomCleaning_CustomParams();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getCustomCleaningCustomCleaningCustomParamsCompartment_7016SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return CustomParamEditPart.VISUAL_ID == PythonpipelineVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getCustomCleaningCustomCleaningCustomParamsCompartment_7016SemanticChildren(
