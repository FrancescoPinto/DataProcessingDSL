...
import pipelineproject.diagram.edit.policies.PrimaryKeyItemSemanticEditPolicy;
...
public class PrimaryKeyEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new PrimaryKeyItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PrimaryKeyNameEditPart) {
			((PrimaryKeyNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigurePrimaryKeyLabelFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PipelineprojectVisualIDRegistry.getType(PrimaryKeyNameEditPart.VISUAL_ID));
	}

	/**
	 * @generated
	 */
	public class PrimaryKeyFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigurePrimaryKeyLabelFigure.setText("PrimaryKey");
