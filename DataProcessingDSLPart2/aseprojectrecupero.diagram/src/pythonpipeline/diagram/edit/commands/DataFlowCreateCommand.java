...
public class DataFlowCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		return PythonpipelineBaseItemSemanticEditPolicy.getLinkConstraints().canCreateDataFlow_4001(getContainer(),
				getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		DataFlow newElement = PythonpipelineFactory.eINSTANCE.createDataFlow();
