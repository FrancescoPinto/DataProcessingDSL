...
public class RuntimeInfoExecutionIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PythonpipelineParserProvider.getParser(PythonpipelineElementTypes.RuntimeInfo_3001,
					getParserElement(), PythonpipelineVisualIDRegistry
							.getType(pythonpipeline.diagram.edit.parts.RuntimeInfoExecutionIdEditPart.VISUAL_ID));
		}
		return parser;
	}
