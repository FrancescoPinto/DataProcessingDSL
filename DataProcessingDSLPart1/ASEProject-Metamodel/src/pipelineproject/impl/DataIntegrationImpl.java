 ...
 * </p>
 * <ul>
 *   <li>{@link pipelineproject.impl.DataIntegrationImpl#getJoinAttributesList <em>Join Attributes List</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataIntegrationImpl extends TaskImpl implements DataIntegration {
	...
	protected EClass eStaticClass() {
		return PipelineprojectPackage.Literals.DATA_INTEGRATION;
	}
	...
	public NotificationChain basicSetJoinAttributesList(JoinAttributesList newJoinAttributesList, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PipelineprojectPackage.DATA_INTEGRATION__JOIN_ATTRIBUTES_LIST, oldJoinAttributesList, newJoinAttributesList);
	...
	public void setJoinAttributesList(JoinAttributesList newJoinAttributesList) {
		if (newJoinAttributesList != joinAttributesList) {
			...
			if (joinAttributesList != null)
				msgs = ((InternalEObject)joinAttributesList).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PipelineprojectPackage.DATA_INTEGRATION__JOIN_ATTRIBUTES_LIST, null, msgs);
			if (newJoinAttributesList != null)
				msgs = ((InternalEObject)newJoinAttributesList).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PipelineprojectPackage.DATA_INTEGRATION__JOIN_ATTRIBUTES_LIST, null, msgs);
			msgs = basicSetJoinAttributesList(newJoinAttributesList, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PipelineprojectPackage.DATA_INTEGRATION__JOIN_ATTRIBUTES_LIST, newJoinAttributesList, newJoinAttributesList));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PipelineprojectPackage.DATA_INTEGRATION__JOIN_ATTRIBUTES_LIST:
