 ...
 * @generated
 */
public class DataIntegrationDataIntegrationJoinAttributesListCompartmentCanonicalEditPolicy
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PipelineprojectPackage.eINSTANCE.getDataIntegration_JoinAttributesList();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getDataIntegrationDataIntegrationJoinAttributesListCompartment_7127SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return JoinAttributesListEditPart.VISUAL_ID == PipelineprojectVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getDataIntegrationDataIntegrationJoinAttributesListCompartment_7127SemanticChildren(
