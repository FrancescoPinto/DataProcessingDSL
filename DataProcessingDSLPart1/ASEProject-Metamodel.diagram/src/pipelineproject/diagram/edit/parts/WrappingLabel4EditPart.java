...
public class WrappingLabel4EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(PipelineprojectVisualIDRegistry
				.getType(pipelineproject.diagram.edit.parts.WrappingLabel4EditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineprojectParserProvider.getParser(PipelineprojectElementTypes.PrimaryKeyCopies_4017,
