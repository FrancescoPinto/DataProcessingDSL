...
import pipelineproject.diagram.edit.policies.GeClauseItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GeClauseEditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public GeClauseEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new GeClauseItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GeClauseIdEditPart) {
			((GeClauseIdEditPart) childEditPart).setLabel(getPrimaryShape().getFigureGeClauseLabelFigure());
			return true;
		}
		if (childEditPart instanceof GeClauseGeClauseConditionFieldCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGeClauseConditionFieldCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GeClauseGeClauseConditionFieldCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GeClauseGeClauseConditionFieldCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getGeClauseConditionFieldCompartmentFigure();
			pane.remove(((GeClauseGeClauseConditionFieldCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GeClauseGeClauseConditionFieldCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PipelineprojectVisualIDRegistry.getType(GeClauseIdEditPart.VISUAL_ID));
	}
