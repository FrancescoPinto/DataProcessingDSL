 ...
 * @generated
 */
public class PipelineprojectModelingAssistantProvider extends ModelingAssistantProvider {
	...
	*/
	protected EObject selectElement(EObject[] elements) {
		...
		dialog.setMessage(Messages.PipelineprojectModelingAssistantProviderMessage);
		dialog.setTitle(Messages.PipelineprojectModelingAssistantProviderTitle);
