 ...
 * @generated
 */
public class EqClauseEqClauseConditionFieldCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getEqClauseEqClauseConditionFieldCompartment_7113SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getEqClauseEqClauseConditionFieldCompartment_7113SemanticChildren((View) getHost().getModel());
