 ...
 * @generated
 */
public class SchemaSchemaAttributesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PipelineprojectPackage.eINSTANCE.getSchema_Attributes();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getSchemaSchemaAttributesCompartment_7130SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return AttributeEditPart.VISUAL_ID == PipelineprojectVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getSchemaSchemaAttributesCompartment_7130SemanticChildren((View) getHost().getModel());
