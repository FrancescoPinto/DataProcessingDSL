...
public class ScatterPlotScatterPlotRuntimeInfoCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getScatterPlotScatterPlotRuntimeInfoCompartment_7137SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getScatterPlotScatterPlotRuntimeInfoCompartment_7137SemanticChildren((View) getHost().getModel());
