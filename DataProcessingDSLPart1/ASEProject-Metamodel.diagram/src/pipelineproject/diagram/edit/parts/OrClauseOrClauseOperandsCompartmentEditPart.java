...
import pipelineproject.diagram.edit.policies.OrClauseOrClauseOperandsCompartmentCanonicalEditPolicy;
import pipelineproject.diagram.edit.policies.OrClauseOrClauseOperandsCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OrClauseOrClauseOperandsCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public OrClauseOrClauseOperandsCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.OrClauseOrClauseOperandsCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new OrClauseOrClauseOperandsCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(PipelineprojectVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new OrClauseOrClauseOperandsCompartmentCanonicalEditPolicy());
	}
