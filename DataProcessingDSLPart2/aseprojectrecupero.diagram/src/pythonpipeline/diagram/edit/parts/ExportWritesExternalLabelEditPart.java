...
public class ExportWritesExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				PythonpipelineVisualIDRegistry
						.getType(pythonpipeline.diagram.edit.parts.ExportWritesExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PythonpipelineParserProvider.getParser(PythonpipelineElementTypes.ExportWrites_4004,
