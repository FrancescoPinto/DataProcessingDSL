...
import pipelineproject.diagram.edit.policies.NotClauseNotClauseSubClauseCompartment2CanonicalEditPolicy;
import pipelineproject.diagram.edit.policies.NotClauseNotClauseSubClauseCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class NotClauseNotClauseSubClauseCompartment2EditPart extends ShapeCompartmentEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 7117;

	/**
	* @generated
	*/
	public NotClauseNotClauseSubClauseCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.NotClauseNotClauseSubClauseCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new NotClauseNotClauseSubClauseCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(PipelineprojectVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new NotClauseNotClauseSubClauseCompartment2CanonicalEditPolicy());
	}
