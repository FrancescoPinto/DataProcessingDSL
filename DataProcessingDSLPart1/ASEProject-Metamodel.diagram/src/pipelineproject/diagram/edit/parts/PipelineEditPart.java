...
import pipelineproject.diagram.edit.commands.PipelineprojectCreateShortcutDecorationsCommand;
import pipelineproject.diagram.edit.policies.PipelineCanonicalEditPolicy;
import pipelineproject.diagram.edit.policies.PipelineItemSemanticEditPolicy;
...
public class PipelineEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "Pipelineproject"; //$NON-NLS-1$
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DiagramDragDropEditPolicy() {
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(new PipelineprojectCreateShortcutDecorationsCommand(
