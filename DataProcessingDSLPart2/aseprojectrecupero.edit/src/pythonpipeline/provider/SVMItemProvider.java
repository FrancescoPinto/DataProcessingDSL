...
/**
 * This is the item provider adapter for a {@link pythonpipeline.SVM} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SVMItemProvider extends ClassificationItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addKernelParamsPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PythonpipelinePackage.Literals.SVM__KERNEL_FUNCTION,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PythonpipelinePackage.Literals.SVM__ESTIMATED_COEFFICIENTS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	 ...
	 * @generated
	 */
	protected void addKernelParamsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_SVM_kernelParams_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_SVM_kernelParams_feature", "_UI_SVM_type"),
				 PythonpipelinePackage.Literals.SVM__KERNEL_PARAMS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PythonpipelinePackage.Literals.SVM__SUPPORT_VECTORS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PythonpipelinePackage.Literals.SVM__SUPPORT_VECTORS,
				 PythonpipelineFactory.eINSTANCE.createSupportVector()));
	}
