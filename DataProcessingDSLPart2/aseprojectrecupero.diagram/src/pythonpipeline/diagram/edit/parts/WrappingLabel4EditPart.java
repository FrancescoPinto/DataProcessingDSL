...
public class WrappingLabel4EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(PythonpipelineVisualIDRegistry
				.getType(pythonpipeline.diagram.edit.parts.WrappingLabel4EditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PythonpipelineParserProvider.getParser(PythonpipelineElementTypes.PrimaryKeyCopies_4006,
