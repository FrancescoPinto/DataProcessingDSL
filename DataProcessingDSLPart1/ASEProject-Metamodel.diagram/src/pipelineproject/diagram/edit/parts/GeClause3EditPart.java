...
import pipelineproject.diagram.edit.policies.GeClause3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class GeClause3EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public GeClause3EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new GeClause3ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof GeClauseId3EditPart) {
			((GeClauseId3EditPart) childEditPart).setLabel(getPrimaryShape().getFigureGeClauseLabelFigure());
			return true;
		}
		if (childEditPart instanceof GeClauseGeClauseConditionFieldCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getGeClauseConditionFieldCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((GeClauseGeClauseConditionFieldCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof GeClauseGeClauseConditionFieldCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getGeClauseConditionFieldCompartmentFigure();
			pane.remove(((GeClauseGeClauseConditionFieldCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof GeClauseGeClauseConditionFieldCompartment3EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PipelineprojectVisualIDRegistry.getType(GeClauseId3EditPart.VISUAL_ID));
	}
