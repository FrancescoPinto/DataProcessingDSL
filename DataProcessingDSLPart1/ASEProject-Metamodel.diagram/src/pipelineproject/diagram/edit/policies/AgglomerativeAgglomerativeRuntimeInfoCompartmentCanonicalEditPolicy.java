...
public class AgglomerativeAgglomerativeRuntimeInfoCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getAgglomerativeAgglomerativeRuntimeInfoCompartment_7077SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getAgglomerativeAgglomerativeRuntimeInfoCompartment_7077SemanticChildren((View) getHost().getModel());
