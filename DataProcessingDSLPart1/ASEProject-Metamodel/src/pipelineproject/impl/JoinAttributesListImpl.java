 ...
 * </p>
 * <ul>
 *   <li>{@link pipelineproject.impl.JoinAttributesListImpl#getJoinAttributes <em>Join Attributes</em>}</li>
 *   <li>{@link pipelineproject.impl.JoinAttributesListImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JoinAttributesListImpl extends EObjectImpl implements JoinAttributesList {
	...
	protected EClass eStaticClass() {
		return PipelineprojectPackage.Literals.JOIN_ATTRIBUTES_LIST;
	}
	...
	public EList<Column> getJoinAttributes() {
		if (joinAttributes == null) {
			joinAttributes = new EObjectResolvingEList<Column>(Column.class, this, PipelineprojectPackage.JOIN_ATTRIBUTES_LIST__JOIN_ATTRIBUTES);
		}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PipelineprojectPackage.JOIN_ATTRIBUTES_LIST__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PipelineprojectPackage.JOIN_ATTRIBUTES_LIST__JOIN_ATTRIBUTES:
