...
/**
 * This is the item provider adapter for a {@link pipelineproject.KMeans} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class KMeansItemProvider extends ClusteringItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_KMeans_K_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_KMeans_K_feature", "_UI_KMeans_type"),
				 PipelineprojectPackage.Literals.KMEANS__K,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((KMeans)object).getId();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(KMeans.class)) {
			case PipelineprojectPackage.KMEANS__K:
