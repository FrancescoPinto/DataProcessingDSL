...
import pipelineproject.diagram.edit.policies.DBSCANItemSemanticEditPolicy;
...
public class DBSCANEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PipelineprojectVisualIDRegistry.getType(DBSCANIdEditPart.VISUAL_ID));
	}
