 ...
 * @generated
 */
public class NotClauseNotClauseSubClauseCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PipelineprojectPackage.eINSTANCE.getNotClause_SubClause();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getNotClauseNotClauseSubClauseCompartment_7117SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getNotClauseNotClauseSubClauseCompartment_7117SemanticChildren((View) getHost().getModel());
