 ...
 * </p>
 * <ul>
 *   <li>{@link pythonpipeline.KMeans#getK <em>K</em>}</li>
 * </ul>
 *
 * @see pythonpipeline.PythonpipelinePackage#getKMeans()
...
public interface KMeans extends Clustering {
	 ...
	 * @see #setK(BigInteger)
	 * @see pythonpipeline.PythonpipelinePackage#getKMeans_K()
	 * @model required="true"
	 * @generated
	 */
	BigInteger getK();
	...
	/**
	 * Sets the value of the '{@link pythonpipeline.KMeans#getK <em>K</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
