 ...
 * @generated
 */
public class JarvisPatrickIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public JarvisPatrickIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineprojectParserProvider.getParser(PipelineprojectElementTypes.JarvisPatrick_2043,
					getParserElement(), PipelineprojectVisualIDRegistry
							.getType(pipelineproject.diagram.edit.parts.JarvisPatrickIdEditPart.VISUAL_ID));
		}
		return parser;
	}
