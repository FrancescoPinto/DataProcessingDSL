...
public class LabeledScatterPlotLabeledScatterPlotRuntimeInfoCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getLabeledScatterPlotLabeledScatterPlotRuntimeInfoCompartment_7136SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getLabeledScatterPlotLabeledScatterPlotRuntimeInfoCompartment_7136SemanticChildren(
