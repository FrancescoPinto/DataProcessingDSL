 ...
 * @generated
 */
public class SkewnessSkewnessRuntimeInfoCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getSkewnessSkewnessRuntimeInfoCompartment_7012SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getSkewnessSkewnessRuntimeInfoCompartment_7012SemanticChildren((View) getHost().getModel());
