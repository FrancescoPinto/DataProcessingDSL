...
/**
 * This is the item provider adapter for a {@link pipelineproject.ScatterPlot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScatterPlotItemProvider extends DataVisualizationItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addResponseVariablesPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PipelineprojectPackage.Literals.SCATTER_PLOT__INDEPENDENT_VARIABLES,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Response Variables feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addResponseVariablesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScatterPlot_responseVariables_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScatterPlot_responseVariables_feature", "_UI_ScatterPlot_type"),
				 PipelineprojectPackage.Literals.SCATTER_PLOT__RESPONSE_VARIABLES,
				 true,
				 false,
				 true,
				 null,
