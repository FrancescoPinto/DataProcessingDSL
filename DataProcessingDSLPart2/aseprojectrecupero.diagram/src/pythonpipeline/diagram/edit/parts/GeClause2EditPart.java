...
import pythonpipeline.diagram.edit.policies.GeClause2ItemSemanticEditPolicy;
...
public class GeClause2EditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PythonpipelineVisualIDRegistry.getType(GeClauseId2EditPart.VISUAL_ID));
	}
