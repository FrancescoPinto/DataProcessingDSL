 ...
 * </p>
 * <ul>
 *   <li>{@link pythonpipeline.impl.LabeledScatterPlotImpl#getLabelAttribute <em>Label Attribute</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LabeledScatterPlotImpl extends ScatterPlotImpl implements LabeledScatterPlot {
	...
	protected EClass eStaticClass() {
		return PythonpipelinePackage.Literals.LABELED_SCATTER_PLOT;
	}
		...
		if (labelAttribute != null && labelAttribute.eIsProxy()) {
			...
			if (labelAttribute != oldLabelAttribute) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PythonpipelinePackage.LABELED_SCATTER_PLOT__LABEL_ATTRIBUTE, oldLabelAttribute, labelAttribute));
			}
		}
	...
	public void setLabelAttribute(Attribute newLabelAttribute) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.LABELED_SCATTER_PLOT__LABEL_ATTRIBUTE, oldLabelAttribute, labelAttribute));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PythonpipelinePackage.LABELED_SCATTER_PLOT__LABEL_ATTRIBUTE:
