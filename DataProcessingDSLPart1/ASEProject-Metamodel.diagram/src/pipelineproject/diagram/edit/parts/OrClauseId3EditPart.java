 ...
 * @generated
 */
public class OrClauseId3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public OrClauseId3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineprojectParserProvider.getParser(PipelineprojectElementTypes.OrClause_3059,
					getParserElement(), PipelineprojectVisualIDRegistry
							.getType(pipelineproject.diagram.edit.parts.OrClauseId3EditPart.VISUAL_ID));
		}
		return parser;
	}
