 ...
 * @generated
 */
public class LogisticRegressionLogisticRegressionRuntimeInfoCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PythonpipelinePackage.eINSTANCE.getTask_RuntimeInfo();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getLogisticRegressionLogisticRegressionRuntimeInfoCompartment_7011SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return RuntimeInfoEditPart.VISUAL_ID == PythonpipelineVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getLogisticRegressionLogisticRegressionRuntimeInfoCompartment_7011SemanticChildren(
