 ...
 * </p>
 * <ul>
 *   <li>{@link pythonpipeline.impl.InputSourceDeclarationImpl#getSourceURI <em>Source URI</em>}</li>
 *   <li>{@link pythonpipeline.impl.InputSourceDeclarationImpl#getQueryEndpoint <em>Query Endpoint</em>}</li>
 *   <li>{@link pythonpipeline.impl.InputSourceDeclarationImpl#getExchangeFormat <em>Exchange Format</em>}</li>
 *   <li>{@link pythonpipeline.impl.InputSourceDeclarationImpl#getSourceSchema <em>Source Schema</em>}</li>
 *   <li>{@link pythonpipeline.impl.InputSourceDeclarationImpl#getSourceType <em>Source Type</em>}</li>
 *   <li>{@link pythonpipeline.impl.InputSourceDeclarationImpl#getQueryConditions <em>Query Conditions</em>}</li>
 *   <li>{@link pythonpipeline.impl.InputSourceDeclarationImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InputSourceDeclarationImpl extends EObjectImpl implements InputSourceDeclaration {
	...
	protected EClass eStaticClass() {
		return PythonpipelinePackage.Literals.INPUT_SOURCE_DECLARATION;
	}
	...
	public void setSourceURI(String newSourceURI) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.INPUT_SOURCE_DECLARATION__SOURCE_URI, oldSourceURI, sourceURI));
	}
	...
	public void setQueryEndpoint(String newQueryEndpoint) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.INPUT_SOURCE_DECLARATION__QUERY_ENDPOINT, oldQueryEndpoint, queryEndpoint));
	}
	...
	public void setExchangeFormat(Format newExchangeFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.INPUT_SOURCE_DECLARATION__EXCHANGE_FORMAT, oldExchangeFormat, exchangeFormat));
	}
	...
	public Schema getSourceSchema() {
		if (sourceSchema != null && sourceSchema.eIsProxy()) {
			...
			if (sourceSchema != oldSourceSchema) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PythonpipelinePackage.INPUT_SOURCE_DECLARATION__SOURCE_SCHEMA, oldSourceSchema, sourceSchema));
			}
		}
		return sourceSchema;
	}
	...
	public void setSourceSchema(Schema newSourceSchema) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.INPUT_SOURCE_DECLARATION__SOURCE_SCHEMA, oldSourceSchema, sourceSchema));
	}
	...
	public void setSourceType(SourceType newSourceType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.INPUT_SOURCE_DECLARATION__SOURCE_TYPE, oldSourceType, sourceType));
	}
	...
	public NotificationChain basicSetQueryConditions(LogicProposition newQueryConditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.INPUT_SOURCE_DECLARATION__QUERY_CONDITIONS, oldQueryConditions, newQueryConditions);
	...
	public void setQueryConditions(LogicProposition newQueryConditions) {
		if (newQueryConditions != queryConditions) {
			...
			if (queryConditions != null)
				msgs = ((InternalEObject)queryConditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PythonpipelinePackage.INPUT_SOURCE_DECLARATION__QUERY_CONDITIONS, null, msgs);
			if (newQueryConditions != null)
				msgs = ((InternalEObject)newQueryConditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PythonpipelinePackage.INPUT_SOURCE_DECLARATION__QUERY_CONDITIONS, null, msgs);
			msgs = basicSetQueryConditions(newQueryConditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.INPUT_SOURCE_DECLARATION__QUERY_CONDITIONS, newQueryConditions, newQueryConditions));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.INPUT_SOURCE_DECLARATION__ID, oldId, id));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case PythonpipelinePackage.INPUT_SOURCE_DECLARATION__SOURCE_SCHEMA:
