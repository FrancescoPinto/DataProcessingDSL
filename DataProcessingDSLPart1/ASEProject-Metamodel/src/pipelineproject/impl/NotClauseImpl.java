 ...
 * </p>
 * <ul>
 *   <li>{@link pipelineproject.impl.NotClauseImpl#getSubClause <em>Sub Clause</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NotClauseImpl extends LogicPropositionImpl implements NotClause {
	...
	protected EClass eStaticClass() {
		return PipelineprojectPackage.Literals.NOT_CLAUSE;
	}
	...
	public NotificationChain basicSetSubClause(LogicProposition newSubClause, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PipelineprojectPackage.NOT_CLAUSE__SUB_CLAUSE, oldSubClause, newSubClause);
	...
	public void setSubClause(LogicProposition newSubClause) {
		if (newSubClause != subClause) {
			...
			if (subClause != null)
				msgs = ((InternalEObject)subClause).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PipelineprojectPackage.NOT_CLAUSE__SUB_CLAUSE, null, msgs);
			if (newSubClause != null)
				msgs = ((InternalEObject)newSubClause).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PipelineprojectPackage.NOT_CLAUSE__SUB_CLAUSE, null, msgs);
			msgs = basicSetSubClause(newSubClause, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PipelineprojectPackage.NOT_CLAUSE__SUB_CLAUSE, newSubClause, newSubClause));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PipelineprojectPackage.NOT_CLAUSE__SUB_CLAUSE:
