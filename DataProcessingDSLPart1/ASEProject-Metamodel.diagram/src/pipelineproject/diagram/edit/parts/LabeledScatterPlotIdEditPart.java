 ...
 * @generated
 */
public class LabeledScatterPlotIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LabeledScatterPlotIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineprojectParserProvider.getParser(PipelineprojectElementTypes.LabeledScatterPlot_2062,
					getParserElement(), PipelineprojectVisualIDRegistry
							.getType(pipelineproject.diagram.edit.parts.LabeledScatterPlotIdEditPart.VISUAL_ID));
		}
		return parser;
	}
