 ...
 * </p>
 * <ul>
 *   <li>{@link pipelineproject.Ridge#getPenaltyFactor <em>Penalty Factor</em>}</li>
 * </ul>
 *
 * @see pipelineproject.PipelineprojectPackage#getRidge()
...
public interface Ridge extends LinearRegression {
	 ...
	 * @see pipelineproject.PipelineprojectPackage#getRidge_PenaltyFactor()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link pipelineproject.Ridge#getPenaltyFactor <em>Penalty Factor</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
