 ...
 * </p>
 * <ul>
 *   <li>{@link pipelineproject.impl.AgglomerativeImpl#getInterClusterSimilarity <em>Inter Cluster Similarity</em>}</li>
 *   <li>{@link pipelineproject.impl.AgglomerativeImpl#getCutHeight <em>Cut Height</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AgglomerativeImpl extends HierarchicalImpl implements Agglomerative {
	 ...
	 * @ordered
	 */
	protected static final InterClusterSimilarity INTER_CLUSTER_SIMILARITY_EDEFAULT = InterClusterSimilarity.SL;
	...
	protected EClass eStaticClass() {
		return PipelineprojectPackage.Literals.AGGLOMERATIVE;
	}
	...
	public void setInterClusterSimilarity(InterClusterSimilarity newInterClusterSimilarity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PipelineprojectPackage.AGGLOMERATIVE__INTER_CLUSTER_SIMILARITY, oldInterClusterSimilarity, interClusterSimilarity));
	}
	...
	public void setCutHeight(BigInteger newCutHeight) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PipelineprojectPackage.AGGLOMERATIVE__CUT_HEIGHT, oldCutHeight, cutHeight));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PipelineprojectPackage.AGGLOMERATIVE__INTER_CLUSTER_SIMILARITY:
				return getInterClusterSimilarity();
			case PipelineprojectPackage.AGGLOMERATIVE__CUT_HEIGHT:
				return getCutHeight();
		}
