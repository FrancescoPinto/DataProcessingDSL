 ...
 * </p>
 * <ul>
 *   <li>{@link pythonpipeline.LinearRegression#getEstimatedCoefficients <em>Estimated Coefficients</em>}</li>
 * </ul>
 *
 * @see pythonpipeline.PythonpipelinePackage#getLinearRegression()
...
public interface LinearRegression extends Prediction {
	 ...
	 * @see pythonpipeline.PythonpipelinePackage#getLinearRegression_EstimatedCoefficients()
