 ...
 * @generated
 */
public class GeClauseGeClauseConditionFieldCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getGeClauseGeClauseConditionFieldCompartment_7106SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getGeClauseGeClauseConditionFieldCompartment_7106SemanticChildren((View) getHost().getModel());
