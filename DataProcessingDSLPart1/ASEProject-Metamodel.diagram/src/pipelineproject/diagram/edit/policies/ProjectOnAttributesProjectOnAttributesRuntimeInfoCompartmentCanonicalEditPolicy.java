...
public class ProjectOnAttributesProjectOnAttributesRuntimeInfoCompartmentCanonicalEditPolicy
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getProjectOnAttributesProjectOnAttributesRuntimeInfoCompartment_7140SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getProjectOnAttributesProjectOnAttributesRuntimeInfoCompartment_7140SemanticChildren(
