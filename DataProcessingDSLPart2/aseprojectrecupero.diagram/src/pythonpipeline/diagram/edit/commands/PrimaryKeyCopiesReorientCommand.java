 ...
 * @generated
 */
public class PrimaryKeyCopiesReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public PrimaryKeyCopiesReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	public boolean canExecute() {
		if (false == referenceOwner instanceof PrimaryKey) {
			return false;
		}
	...
	*/
	protected boolean canReorientSource() {
		...
		return PythonpipelineBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistPrimaryKeyCopies_4006(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return PythonpipelineBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistPrimaryKeyCopies_4006(getOldSource(), getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setCopies(null);
		getNewSource().setCopies(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setCopies(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
	...
	*/
	protected PrimaryKey getOldSource() {
		return (PrimaryKey) referenceOwner;
	}
