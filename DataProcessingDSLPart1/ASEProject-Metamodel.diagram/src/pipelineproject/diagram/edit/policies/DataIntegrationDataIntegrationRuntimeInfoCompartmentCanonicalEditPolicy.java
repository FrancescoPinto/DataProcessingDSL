...
public class DataIntegrationDataIntegrationRuntimeInfoCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getDataIntegrationDataIntegrationRuntimeInfoCompartment_7126SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getDataIntegrationDataIntegrationRuntimeInfoCompartment_7126SemanticChildren(
