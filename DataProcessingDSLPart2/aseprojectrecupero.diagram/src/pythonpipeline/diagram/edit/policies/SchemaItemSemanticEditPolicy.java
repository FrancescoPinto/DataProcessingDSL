...
import pythonpipeline.diagram.edit.commands.InputSourceDeclarationSourceSchemaCreateCommand;
import pythonpipeline.diagram.edit.commands.InputSourceDeclarationSourceSchemaReorientCommand;
...
import pythonpipeline.diagram.edit.parts.SchemaSchemaAttributesCompartmentEditPart;
import pythonpipeline.diagram.edit.parts.SchemaSchemaIdColumnCompartmentEditPart;
 ...
 * @generated
 */
public class SchemaItemSemanticEditPolicy extends PythonpipelineBaseItemSemanticEditPolicy {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (PythonpipelineVisualIDRegistry.getVisualID(incomingLink) == TaskInputSchemaEditPart.VISUAL_ID) {
			...
			if (PythonpipelineVisualIDRegistry.getVisualID(incomingLink) == TaskOutputSchemaEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(incomingLink.getSource().getElement(), null,
						incomingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
				cmd.add(new DeleteCommand(getEditingDomain(), incomingLink));
			...
			if (PythonpipelineVisualIDRegistry
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (PythonpipelineElementTypes.InputSourceDeclarationSourceSchema_4005 == req.getElementType()) {
			return null;
		}
		return null;
	}
