 ...
 * </p>
 * <ul>
 *   <li>{@link pythonpipeline.impl.ValueClauseImpl#getComparisonValue <em>Comparison Value</em>}</li>
 *   <li>{@link pythonpipeline.impl.ValueClauseImpl#getConditionField <em>Condition Field</em>}</li>
 *   <li>{@link pythonpipeline.impl.ValueClauseImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ValueClauseImpl extends LogicPropositionImpl implements ValueClause {
	...
	protected EClass eStaticClass() {
		return PythonpipelinePackage.Literals.VALUE_CLAUSE;
	}
	...
	public void setComparisonValue(String newComparisonValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.VALUE_CLAUSE__COMPARISON_VALUE, oldComparisonValue, comparisonValue));
	}
	...
	public NotificationChain basicSetConditionField(QueryParam newConditionField, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.VALUE_CLAUSE__CONDITION_FIELD, oldConditionField, newConditionField);
	...
	public void setConditionField(QueryParam newConditionField) {
		if (newConditionField != conditionField) {
			...
			if (conditionField != null)
				msgs = ((InternalEObject)conditionField).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PythonpipelinePackage.VALUE_CLAUSE__CONDITION_FIELD, null, msgs);
			if (newConditionField != null)
				msgs = ((InternalEObject)newConditionField).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PythonpipelinePackage.VALUE_CLAUSE__CONDITION_FIELD, null, msgs);
			msgs = basicSetConditionField(newConditionField, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.VALUE_CLAUSE__CONDITION_FIELD, newConditionField, newConditionField));
	}
	...
	public void setType(Type newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.VALUE_CLAUSE__TYPE, oldType, type));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PythonpipelinePackage.VALUE_CLAUSE__CONDITION_FIELD:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PythonpipelinePackage.VALUE_CLAUSE__COMPARISON_VALUE:
				return getComparisonValue();
			case PythonpipelinePackage.VALUE_CLAUSE__CONDITION_FIELD:
				return getConditionField();
			case PythonpipelinePackage.VALUE_CLAUSE__TYPE:
				return getType();
		}
