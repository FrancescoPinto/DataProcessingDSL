 ...
 * @generated
 */
public class LeClauseLeClauseConditionFieldCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getLeClauseLeClauseConditionFieldCompartment_7122SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getLeClauseLeClauseConditionFieldCompartment_7122SemanticChildren((View) getHost().getModel());
