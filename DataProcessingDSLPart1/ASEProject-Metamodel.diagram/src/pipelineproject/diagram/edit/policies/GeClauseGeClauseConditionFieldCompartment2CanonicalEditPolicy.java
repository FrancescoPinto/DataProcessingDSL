 ...
 * @generated
 */
public class GeClauseGeClauseConditionFieldCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getGeClauseGeClauseConditionFieldCompartment_7115SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getGeClauseGeClauseConditionFieldCompartment_7115SemanticChildren((View) getHost().getModel());
