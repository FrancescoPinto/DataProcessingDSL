...
/**
 * This is the item provider adapter for a {@link pipelineproject.Schema} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchemaItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PipelineprojectPackage.Literals.SCHEMA__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PipelineprojectPackage.Literals.SCHEMA__ATTRIBUTES);
			childrenFeatures.add(PipelineprojectPackage.Literals.SCHEMA__ID_COLUMN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PipelineprojectPackage.Literals.SCHEMA__ATTRIBUTES,
				 PipelineprojectFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(PipelineprojectPackage.Literals.SCHEMA__ID_COLUMN,
				 PipelineprojectFactory.eINSTANCE.createPrimaryKey()));
	}
