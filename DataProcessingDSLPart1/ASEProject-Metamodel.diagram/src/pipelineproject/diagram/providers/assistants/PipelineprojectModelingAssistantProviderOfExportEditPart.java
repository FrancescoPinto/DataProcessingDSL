 ...
 * @generated
 */
public class PipelineprojectModelingAssistantProviderOfExportEditPart extends PipelineprojectModelingAssistantProvider {
	...
	*/
	public List<IElementType> doGetTypesForTarget(ExportEditPart source, IElementType relationshipType) {
		...
		if (relationshipType == PipelineprojectElementTypes.DataFlow_4007) {
			...
			types.add(PipelineprojectElementTypes.Schema_2057);
		} else if (relationshipType == PipelineprojectElementTypes.ExportWrites_4010) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((ExportEditPart) targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnTarget(ExportEditPart target) {
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((ExportEditPart) targetEditPart, relationshipType);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(ExportEditPart target, IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == PipelineprojectElementTypes.DataFlow_4007) {
			types.add(PipelineprojectElementTypes.Agglomerative_2035);
			types.add(PipelineprojectElementTypes.Ridge_2036);
