 ...
 * @generated
 */
public class ExportWritesExternalLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				PipelineprojectVisualIDRegistry
						.getType(pipelineproject.diagram.edit.parts.ExportWritesExternalLabelEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	* @generated
	*/
	public ExportWritesExternalLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineprojectParserProvider.getParser(PipelineprojectElementTypes.ExportWrites_4010,
	...
	*/
	protected IFigure createFigurePrim() {
		return new ExportWritesExternalLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ExportWritesExternalLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ExportWritesExternalLabelFigure() {
			this.setText("writes");
		}
