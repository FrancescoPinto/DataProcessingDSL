...
public class CustomCleaningCustomCleaningRuntimeInfoCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getCustomCleaningCustomCleaningRuntimeInfoCompartment_7093SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getCustomCleaningCustomCleaningRuntimeInfoCompartment_7093SemanticChildren(
