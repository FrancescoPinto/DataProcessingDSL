 ...
 * @generated
 */
public class RuntimeInfoExecutionIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RuntimeInfoExecutionIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineprojectParserProvider.getParser(PipelineprojectElementTypes.RuntimeInfo_3036,
					getParserElement(), PipelineprojectVisualIDRegistry
							.getType(pipelineproject.diagram.edit.parts.RuntimeInfoExecutionIdEditPart.VISUAL_ID));
		}
		return parser;
	}
