...
import pipelineproject.diagram.edit.parts.InputSourceDeclarationInputSourceDeclarationQueryConditionsCompartmentEditPart;
 ...
 * @generated
 */
public class InputSourceDeclarationItemSemanticEditPolicy extends PipelineprojectBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public InputSourceDeclarationItemSemanticEditPolicy() {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (PipelineprojectVisualIDRegistry
					.getVisualID(outgoingLink) == InputSourceDeclarationSourceSchemaEditPart.VISUAL_ID) {
