...
public class NotClauseNotClauseSubClauseCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PythonpipelinePackage.eINSTANCE.getNotClause_SubClause();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getNotClauseNotClauseSubClauseCompartment_7051SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getNotClauseNotClauseSubClauseCompartment_7051SemanticChildren((View) getHost().getModel());
