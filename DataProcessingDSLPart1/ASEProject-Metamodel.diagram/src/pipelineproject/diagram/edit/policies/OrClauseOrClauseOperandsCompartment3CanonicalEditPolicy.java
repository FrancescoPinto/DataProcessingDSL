 ...
 * @generated
 */
public class OrClauseOrClauseOperandsCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getOrClauseOrClauseOperandsCompartment_7118SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getOrClauseOrClauseOperandsCompartment_7118SemanticChildren((View) getHost().getModel());
