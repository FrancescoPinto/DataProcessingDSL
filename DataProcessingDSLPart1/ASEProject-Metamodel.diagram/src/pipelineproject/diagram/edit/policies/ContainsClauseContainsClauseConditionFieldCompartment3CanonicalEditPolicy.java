 ...
 * @generated
 */
public class ContainsClauseContainsClauseConditionFieldCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getContainsClauseContainsClauseConditionFieldCompartment_7124SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getContainsClauseContainsClauseConditionFieldCompartment_7124SemanticChildren(
