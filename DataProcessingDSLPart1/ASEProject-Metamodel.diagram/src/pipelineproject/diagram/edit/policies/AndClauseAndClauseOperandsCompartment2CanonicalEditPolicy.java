 ...
 * @generated
 */
public class AndClauseAndClauseOperandsCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getAndClauseAndClauseOperandsCompartment_7100SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getAndClauseAndClauseOperandsCompartment_7100SemanticChildren((View) getHost().getModel());
