 ...
 * @generated
 */
public class TaskOutputSchemaReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public TaskOutputSchemaReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return PythonpipelineBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTaskOutputSchema_4003(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return PythonpipelineBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTaskOutputSchema_4003(getOldSource(), getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getOutputSchema().remove(getOldTarget());
		getNewSource().getOutputSchema().add(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getOutputSchema().remove(getOldTarget());
		getOldSource().getOutputSchema().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
