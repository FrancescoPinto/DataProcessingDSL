 ...
 * @generated
 */
public class DataCollectionDataCollectionSourceDeclarationCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PipelineprojectPackage.eINSTANCE.getDataCollection_SourceDeclaration();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getDataCollectionDataCollectionSourceDeclarationCompartment_7097SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return InputSourceDeclarationEditPart.VISUAL_ID == PipelineprojectVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getDataCollectionDataCollectionSourceDeclarationCompartment_7097SemanticChildren(
