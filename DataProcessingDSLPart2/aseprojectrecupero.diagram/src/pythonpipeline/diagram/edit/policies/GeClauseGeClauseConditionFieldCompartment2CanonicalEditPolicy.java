...
public class GeClauseGeClauseConditionFieldCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getGeClauseGeClauseConditionFieldCompartment_7041SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getGeClauseGeClauseConditionFieldCompartment_7041SemanticChildren((View) getHost().getModel());
