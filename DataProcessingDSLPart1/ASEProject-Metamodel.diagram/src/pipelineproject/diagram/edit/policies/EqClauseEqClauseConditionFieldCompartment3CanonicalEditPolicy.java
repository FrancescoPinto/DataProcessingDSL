 ...
 * @generated
 */
public class EqClauseEqClauseConditionFieldCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getEqClauseEqClauseConditionFieldCompartment_7121SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getEqClauseEqClauseConditionFieldCompartment_7121SemanticChildren((View) getHost().getModel());
