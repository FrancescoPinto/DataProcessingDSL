...
public class ExportWritesReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return PipelineprojectBaseItemSemanticEditPolicy.getLinkConstraints().canExistExportWrites_4010(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return PipelineprojectBaseItemSemanticEditPolicy.getLinkConstraints().canExistExportWrites_4010(getOldSource(),
				getNewTarget());
	}
