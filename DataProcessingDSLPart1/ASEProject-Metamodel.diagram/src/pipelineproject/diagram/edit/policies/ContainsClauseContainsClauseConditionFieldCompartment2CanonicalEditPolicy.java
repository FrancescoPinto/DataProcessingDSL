 ...
 * @generated
 */
public class ContainsClauseContainsClauseConditionFieldCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PipelineprojectPackage.eINSTANCE.getValueClause_ConditionField();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getContainsClauseContainsClauseConditionFieldCompartment_7116SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return QueryParamEditPart.VISUAL_ID == PipelineprojectVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getContainsClauseContainsClauseConditionFieldCompartment_7116SemanticChildren(
