...
import pythonpipeline.diagram.edit.parts.DataCollectionDataCollectionRuntimeInfoCompartmentEditPart;
import pythonpipeline.diagram.edit.parts.DataCollectionDataCollectionSourceDeclarationCompartmentEditPart;
 ...
 * @generated
 */
public class DataCollectionItemSemanticEditPolicy extends PythonpipelineBaseItemSemanticEditPolicy {
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					case InputSourceDeclarationEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							Edge outgoingLink = (Edge) it.next();
							if (PythonpipelineVisualIDRegistry.getVisualID(
