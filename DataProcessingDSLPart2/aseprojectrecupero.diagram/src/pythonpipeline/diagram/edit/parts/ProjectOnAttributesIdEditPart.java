...
public class ProjectOnAttributesIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PythonpipelineParserProvider.getParser(PythonpipelineElementTypes.ProjectOnAttributes_2020,
					getParserElement(), PythonpipelineVisualIDRegistry
							.getType(pythonpipeline.diagram.edit.parts.ProjectOnAttributesIdEditPart.VISUAL_ID));
		}
		return parser;
	}
