...
public class DataCollectionDataCollectionSourceDeclarationCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PythonpipelinePackage.eINSTANCE.getDataCollection_SourceDeclaration();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getDataCollectionDataCollectionSourceDeclarationCompartment_7023SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return InputSourceDeclarationEditPart.VISUAL_ID == PythonpipelineVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getDataCollectionDataCollectionSourceDeclarationCompartment_7023SemanticChildren(
