 ...
 * @generated
 */
public class PythonpipelineModelingAssistantProviderOfExportEditPart extends PythonpipelineModelingAssistantProvider {
	...
	*/
	public List<IElementType> doGetTypesForTarget(ExportEditPart source, IElementType relationshipType) {
		...
		if (relationshipType == PythonpipelineElementTypes.DataFlow_4001) {
			...
			types.add(PythonpipelineElementTypes.Schema_2024);
		} else if (relationshipType == PythonpipelineElementTypes.ExportWrites_4004) {
