 ...
 * @generated
 */
public class AndClauseAndClauseOperandsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getAndClauseAndClauseOperandsCompartment_7099SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getAndClauseAndClauseOperandsCompartment_7099SemanticChildren((View) getHost().getModel());
