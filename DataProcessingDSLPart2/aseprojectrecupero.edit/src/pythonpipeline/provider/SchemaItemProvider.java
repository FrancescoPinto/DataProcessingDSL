...
/**
 * This is the item provider adapter for a {@link pythonpipeline.Schema} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SchemaItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PythonpipelinePackage.Literals.SCHEMA__ID,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PythonpipelinePackage.Literals.SCHEMA__ATTRIBUTES);
			childrenFeatures.add(PythonpipelinePackage.Literals.SCHEMA__ID_COLUMN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PythonpipelinePackage.Literals.SCHEMA__ATTRIBUTES,
				 PythonpipelineFactory.eINSTANCE.createAttribute()));

		newChildDescriptors.add
			(createChildParameter
				(PythonpipelinePackage.Literals.SCHEMA__ID_COLUMN,
				 PythonpipelineFactory.eINSTANCE.createPrimaryKey()));
	}
