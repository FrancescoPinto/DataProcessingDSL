...
/**
 * This is the item provider adapter for a {@link pipelineproject.InputSourceDeclaration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class InputSourceDeclarationItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PipelineprojectPackage.Literals.INPUT_SOURCE_DECLARATION__SOURCE_URI,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PipelineprojectPackage.Literals.INPUT_SOURCE_DECLARATION__QUERY_ENDPOINT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PipelineprojectPackage.Literals.INPUT_SOURCE_DECLARATION__EXCHANGE_FORMAT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PipelineprojectPackage.Literals.INPUT_SOURCE_DECLARATION__SOURCE_SCHEMA,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PipelineprojectPackage.Literals.INPUT_SOURCE_DECLARATION__SOURCE_TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PipelineprojectPackage.Literals.INPUT_SOURCE_DECLARATION__QUERY_CONDITIONS);
		}
	...
	public String getText(Object object) {
		String label = ((InputSourceDeclaration)object).getSourceURI();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PipelineprojectPackage.Literals.INPUT_SOURCE_DECLARATION__QUERY_CONDITIONS,
