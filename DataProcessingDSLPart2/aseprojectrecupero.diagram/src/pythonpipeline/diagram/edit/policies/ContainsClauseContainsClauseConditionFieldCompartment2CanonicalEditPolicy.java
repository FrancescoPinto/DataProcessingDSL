...
public class ContainsClauseContainsClauseConditionFieldCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PythonpipelinePackage.eINSTANCE.getValueClause_ConditionField();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getContainsClauseContainsClauseConditionFieldCompartment_7042SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return QueryParamEditPart.VISUAL_ID == PythonpipelineVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getContainsClauseContainsClauseConditionFieldCompartment_7042SemanticChildren(
