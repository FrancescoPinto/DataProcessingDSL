...
import pipelineproject.diagram.edit.policies.AndClauseAndClauseOperandsCompartment2CanonicalEditPolicy;
import pipelineproject.diagram.edit.policies.AndClauseAndClauseOperandsCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AndClauseAndClauseOperandsCompartment2EditPart extends ShapeCompartmentEditPart {

	/**
	* @generated
	*/
	public static final int VISUAL_ID = 7100;

	/**
	* @generated
	*/
	public AndClauseAndClauseOperandsCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AndClauseAndClauseOperandsCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AndClauseAndClauseOperandsCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(PipelineprojectVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AndClauseAndClauseOperandsCompartment2CanonicalEditPolicy());
	}
