 ...
 * @generated
 */
public class InputSourceDeclarationSourceURIEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InputSourceDeclarationSourceURIEditPart(View view) {
		super(view);
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return PipelineprojectElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineprojectParserProvider.getParser(PipelineprojectElementTypes.InputSourceDeclaration_3038,
					getParserElement(), PipelineprojectVisualIDRegistry.getType(
							pipelineproject.diagram.edit.parts.InputSourceDeclarationSourceURIEditPart.VISUAL_ID));
		}
		return parser;
	}
