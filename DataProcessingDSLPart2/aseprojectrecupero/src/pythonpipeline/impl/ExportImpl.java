 ...
 * </p>
 * <ul>
 *   <li>{@link pythonpipeline.impl.ExportImpl#getWrites <em>Writes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExportImpl extends TaskImpl implements Export {
	...
	protected EClass eStaticClass() {
		return PythonpipelinePackage.Literals.EXPORT;
	}
	...
	public EList<OutputFile> getWrites() {
		if (writes == null) {
			writes = new EObjectWithInverseResolvingEList<OutputFile>(OutputFile.class, this, PythonpipelinePackage.EXPORT__WRITES, PythonpipelinePackage.OUTPUT_FILE__EXPORT);
		}
		return writes;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PythonpipelinePackage.EXPORT__WRITES:
