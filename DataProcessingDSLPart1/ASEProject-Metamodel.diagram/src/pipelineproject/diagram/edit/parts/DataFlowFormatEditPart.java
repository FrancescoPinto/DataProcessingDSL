...
import pipelineproject.diagram.edit.policies.PipelineprojectTextSelectionEditPolicy;
 ...
 * @generated
 */
public class DataFlowFormatEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(PipelineprojectVisualIDRegistry
				.getType(pipelineproject.diagram.edit.parts.DataFlowFormatEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	* @generated
	*/
	public DataFlowFormatEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new PipelineprojectTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineprojectParserProvider.getParser(PipelineprojectElementTypes.DataFlow_4007,
					getParserElement(), PipelineprojectVisualIDRegistry
							.getType(pipelineproject.diagram.edit.parts.DataFlowFormatEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ComboDirectEditManager(this, null,
					PipelineprojectEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	*/
	protected IFigure createFigurePrim() {
		return new DataFlowLabelFigure();
	}

	/**
	 * @generated
	 */
	public class DataFlowLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public DataFlowLabelFigure() {
			this.setText("DataFlow");
		}
