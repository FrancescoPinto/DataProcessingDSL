...
public class NotClauseNotClauseSubClauseCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getNotClauseNotClauseSubClauseCompartment_7043SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getNotClauseNotClauseSubClauseCompartment_7043SemanticChildren((View) getHost().getModel());
