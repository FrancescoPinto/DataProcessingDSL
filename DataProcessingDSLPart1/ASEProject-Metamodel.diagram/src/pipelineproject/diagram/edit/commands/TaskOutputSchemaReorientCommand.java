...
public class TaskOutputSchemaReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return PipelineprojectBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTaskOutputSchema_4016(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return PipelineprojectBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistTaskOutputSchema_4016(getOldSource(), getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setOutputSchema(null);
		getNewSource().setOutputSchema(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setOutputSchema(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
