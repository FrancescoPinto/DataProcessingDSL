 ...
 * </p>
 * <ul>
 *   <li>{@link pythonpipeline.impl.ProjectOnAttributesImpl#getProjectionAttributes <em>Projection Attributes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProjectOnAttributesImpl extends DataCleaningImpl implements ProjectOnAttributes {
	...
	protected EClass eStaticClass() {
		return PythonpipelinePackage.Literals.PROJECT_ON_ATTRIBUTES;
	}
	...
	public EList<Attribute> getProjectionAttributes() {
		if (projectionAttributes == null) {
			projectionAttributes = new EObjectResolvingEList<Attribute>(Attribute.class, this, PythonpipelinePackage.PROJECT_ON_ATTRIBUTES__PROJECTION_ATTRIBUTES);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PythonpipelinePackage.PROJECT_ON_ATTRIBUTES__PROJECTION_ATTRIBUTES:
