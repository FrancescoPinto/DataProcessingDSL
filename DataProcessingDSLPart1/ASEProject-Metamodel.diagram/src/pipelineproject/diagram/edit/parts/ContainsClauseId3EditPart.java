 ...
 * @generated
 */
public class ContainsClauseId3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ContainsClauseId3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineprojectParserProvider.getParser(PipelineprojectElementTypes.ContainsClause_3065,
					getParserElement(), PipelineprojectVisualIDRegistry
							.getType(pipelineproject.diagram.edit.parts.ContainsClauseId3EditPart.VISUAL_ID));
		}
		return parser;
	}
