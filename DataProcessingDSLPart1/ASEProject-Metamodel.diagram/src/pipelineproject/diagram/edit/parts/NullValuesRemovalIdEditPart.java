 ...
 * @generated
 */
public class NullValuesRemovalIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public NullValuesRemovalIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineprojectParserProvider.getParser(PipelineprojectElementTypes.NullValuesRemoval_2050,
					getParserElement(), PipelineprojectVisualIDRegistry
							.getType(pipelineproject.diagram.edit.parts.NullValuesRemovalIdEditPart.VISUAL_ID));
		}
		return parser;
	}
