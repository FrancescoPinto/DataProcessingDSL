...
import pipelineproject.diagram.edit.parts.DataCollectionDataCollectionRuntimeInfoCompartmentEditPart;
import pipelineproject.diagram.edit.parts.DataCollectionDataCollectionSourceDeclarationCompartmentEditPart;
 ...
 * @generated
 */
public class DataCollectionItemSemanticEditPolicy extends PipelineprojectBaseItemSemanticEditPolicy {
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit.hasNext();) {
					...
					case InputSourceDeclarationEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							Edge outgoingLink = (Edge) it.next();
							if (PipelineprojectVisualIDRegistry.getVisualID(
									outgoingLink) == InputSourceDeclarationSourceSchemaEditPart.VISUAL_ID) {
