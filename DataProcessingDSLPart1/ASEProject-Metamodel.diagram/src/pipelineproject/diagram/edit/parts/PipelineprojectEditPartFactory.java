 ...
 * @generated
 */
public class PipelineprojectEditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case KNNEditPart.VISUAL_ID:
				return new KNNEditPart(view);

			case KNNIdEditPart.VISUAL_ID:
				return new KNNIdEditPart(view);
			...
			case JarvisPatrickEditPart.VISUAL_ID:
				return new JarvisPatrickEditPart(view);

			case JarvisPatrickIdEditPart.VISUAL_ID:
				return new JarvisPatrickIdEditPart(view);
			...
			case VarianceEditPart.VISUAL_ID:
				return new VarianceEditPart(view);

			case VarianceIdEditPart.VISUAL_ID:
				return new VarianceIdEditPart(view);
			...
			case KNNKNNRuntimeInfoCompartmentEditPart.VISUAL_ID:
				return new KNNKNNRuntimeInfoCompartmentEditPart(view);
			...
			case JarvisPatrickJarvisPatrickRuntimeInfoCompartmentEditPart.VISUAL_ID:
				return new JarvisPatrickJarvisPatrickRuntimeInfoCompartmentEditPart(view);
			...
			case VarianceVarianceRuntimeInfoCompartmentEditPart.VISUAL_ID:
				return new VarianceVarianceRuntimeInfoCompartmentEditPart(view);
