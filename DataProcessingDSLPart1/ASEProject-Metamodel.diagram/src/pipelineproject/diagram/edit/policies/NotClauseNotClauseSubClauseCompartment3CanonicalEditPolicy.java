 ...
 * @generated
 */
public class NotClauseNotClauseSubClauseCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getNotClauseNotClauseSubClauseCompartment_7125SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getNotClauseNotClauseSubClauseCompartment_7125SemanticChildren((View) getHost().getModel());
