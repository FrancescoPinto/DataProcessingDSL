...
public class InputSourceDeclarationSourceURIEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected Image getLabelIcon() {
		...
		return PythonpipelineElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PythonpipelineParserProvider.getParser(PythonpipelineElementTypes.InputSourceDeclaration_3003,
					getParserElement(), PythonpipelineVisualIDRegistry.getType(
							pythonpipeline.diagram.edit.parts.InputSourceDeclarationSourceURIEditPart.VISUAL_ID));
		}
		return parser;
	}
