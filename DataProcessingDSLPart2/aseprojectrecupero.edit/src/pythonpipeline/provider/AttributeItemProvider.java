...
/**
 * This is the item provider adapter for a {@link pythonpipeline.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider extends ColumnItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_copies_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_copies_feature", "_UI_Attribute_type"),
				 PythonpipelinePackage.Literals.ATTRIBUTE__COPIES,
				 true,
				 false,
				 true,
				 null,
