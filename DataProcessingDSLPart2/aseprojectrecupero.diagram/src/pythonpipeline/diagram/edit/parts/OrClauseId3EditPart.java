...
public class OrClauseId3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PythonpipelineParserProvider.getParser(PythonpipelineElementTypes.OrClause_3024,
					getParserElement(), PythonpipelineVisualIDRegistry
							.getType(pythonpipeline.diagram.edit.parts.OrClauseId3EditPart.VISUAL_ID));
		}
		return parser;
	}
