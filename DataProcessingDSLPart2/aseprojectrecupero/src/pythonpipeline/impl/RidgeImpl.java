 ...
 * </p>
 * <ul>
 *   <li>{@link pythonpipeline.impl.RidgeImpl#getPenaltyFactor <em>Penalty Factor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RidgeImpl extends LinearRegressionImpl implements Ridge {
	...
	protected EClass eStaticClass() {
		return PythonpipelinePackage.Literals.RIDGE;
	}
	...
	public void setPenaltyFactor(BigDecimal newPenaltyFactor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.RIDGE__PENALTY_FACTOR, oldPenaltyFactor, penaltyFactor));
	}
