 ...
 * </p>
 * <ul>
 *   <li>{@link pythonpipeline.impl.LinearRegressionImpl#getEstimatedCoefficients <em>Estimated Coefficients</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinearRegressionImpl extends PredictionImpl implements LinearRegression {
	...
	protected EClass eStaticClass() {
		return PythonpipelinePackage.Literals.LINEAR_REGRESSION;
	}
	...
	public EList<BigDecimal> getEstimatedCoefficients() {
		if (estimatedCoefficients == null) {
			estimatedCoefficients = new EDataTypeEList<BigDecimal>(BigDecimal.class, this, PythonpipelinePackage.LINEAR_REGRESSION__ESTIMATED_COEFFICIENTS);
		}
