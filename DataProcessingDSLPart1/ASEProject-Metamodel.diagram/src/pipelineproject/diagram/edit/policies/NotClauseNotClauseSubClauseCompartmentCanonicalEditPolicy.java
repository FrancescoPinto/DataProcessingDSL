 ...
 * @generated
 */
public class NotClauseNotClauseSubClauseCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getNotClauseNotClauseSubClauseCompartment_7108SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getNotClauseNotClauseSubClauseCompartment_7108SemanticChildren((View) getHost().getModel());
