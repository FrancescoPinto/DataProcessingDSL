 ...
 * @generated
 */
public class GtClauseGtClauseConditionFieldCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getGtClauseGtClauseConditionFieldCompartment_7120SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getGtClauseGtClauseConditionFieldCompartment_7120SemanticChildren((View) getHost().getModel());
