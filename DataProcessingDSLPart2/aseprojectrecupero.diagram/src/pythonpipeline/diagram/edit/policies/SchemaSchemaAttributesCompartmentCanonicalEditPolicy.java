...
public class SchemaSchemaAttributesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PythonpipelinePackage.eINSTANCE.getSchema_Attributes();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getSchemaSchemaAttributesCompartment_7055SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return AttributeEditPart.VISUAL_ID == PythonpipelineVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getSchemaSchemaAttributesCompartment_7055SemanticChildren((View) getHost().getModel());
