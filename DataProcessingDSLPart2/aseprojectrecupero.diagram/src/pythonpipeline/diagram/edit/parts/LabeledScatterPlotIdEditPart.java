...
public class LabeledScatterPlotIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PythonpipelineParserProvider.getParser(PythonpipelineElementTypes.LabeledScatterPlot_2013,
					getParserElement(), PythonpipelineVisualIDRegistry
							.getType(pythonpipeline.diagram.edit.parts.LabeledScatterPlotIdEditPart.VISUAL_ID));
		}
		return parser;
	}
