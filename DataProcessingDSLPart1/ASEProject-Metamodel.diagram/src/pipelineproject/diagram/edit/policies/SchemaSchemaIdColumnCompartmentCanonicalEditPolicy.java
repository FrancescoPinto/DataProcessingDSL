 ...
 * @generated
 */
public class SchemaSchemaIdColumnCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PipelineprojectPackage.eINSTANCE.getSchema_IdColumn();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getSchemaSchemaIdColumnCompartment_7133SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return PrimaryKeyEditPart.VISUAL_ID == PipelineprojectVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getSchemaSchemaIdColumnCompartment_7133SemanticChildren((View) getHost().getModel());
