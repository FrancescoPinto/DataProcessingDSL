 ...
 * @generated
 */
public class DBSCANDBSCANRuntimeInfoCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getDBSCANDBSCANRuntimeInfoCompartment_7006SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getDBSCANDBSCANRuntimeInfoCompartment_7006SemanticChildren((View) getHost().getModel());
