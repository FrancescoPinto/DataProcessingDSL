...
import pythonpipeline.diagram.edit.policies.PythonpipelineTextSelectionEditPolicy;
...
public class DataFlowFormatEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(PythonpipelineVisualIDRegistry
				.getType(pythonpipeline.diagram.edit.parts.DataFlowFormatEditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new PythonpipelineTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PythonpipelineParserProvider.getParser(PythonpipelineElementTypes.DataFlow_4001,
					getParserElement(), PythonpipelineVisualIDRegistry
							.getType(pythonpipeline.diagram.edit.parts.DataFlowFormatEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new ComboDirectEditManager(this, null,
					PythonpipelineEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
