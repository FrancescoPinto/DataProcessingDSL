 ...
 * @generated
 */
public class LtClauseLtClauseConditionFieldCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getLtClauseLtClauseConditionFieldCompartment_7111SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getLtClauseLtClauseConditionFieldCompartment_7111SemanticChildren((View) getHost().getModel());
