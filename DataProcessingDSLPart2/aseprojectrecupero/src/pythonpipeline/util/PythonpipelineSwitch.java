 ...
 * @generated
 */
public class PythonpipelineSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PythonpipelinePackage.STANDARD_DEVIATION: {
				...
				if (result == null) result = caseDescription(standardDeviation);
				if (result == null) result = caseDataAnalysis(standardDeviation);
				if (result == null) result = caseTask(standardDeviation);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case PythonpipelinePackage.SUPPORT_VECTOR: {
				SupportVector supportVector = (SupportVector)theEObject;
				T result = caseSupportVector(supportVector);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Support Vector</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Support Vector</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSupportVector(SupportVector object) {
		return null;
	}
