 ...
 * </p>
 * <ul>
 *   <li>{@link pipelineproject.impl.LassoImpl#getPenaltyFactor <em>Penalty Factor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LassoImpl extends LinearRegressionImpl implements Lasso {
	...
	protected EClass eStaticClass() {
		return PipelineprojectPackage.Literals.LASSO;
	}
	...
	public void setPenaltyFactor(BigDecimal newPenaltyFactor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PipelineprojectPackage.LASSO__PENALTY_FACTOR, oldPenaltyFactor, penaltyFactor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PipelineprojectPackage.LASSO__PENALTY_FACTOR:
