...
/**
 * This is the item provider adapter for a {@link pipelineproject.PrimaryKey} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_PrimaryKey_copies_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_PrimaryKey_copies_feature", "_UI_PrimaryKey_type"),
				 PipelineprojectPackage.Literals.PRIMARY_KEY__COPIES,
				 true,
				 false,
				 true,
				 null,
