...
public class LogisticRegressionLogisticRegressionRuntimeInfoCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getLogisticRegressionLogisticRegressionRuntimeInfoCompartment_7132SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getLogisticRegressionLogisticRegressionRuntimeInfoCompartment_7132SemanticChildren(
