 ...
 * </p>
 * <ul>
 *   <li>{@link pythonpipeline.impl.OutputFileImpl#getFileFormat <em>File Format</em>}</li>
 *   <li>{@link pythonpipeline.impl.OutputFileImpl#getStoragePath <em>Storage Path</em>}</li>
 *   <li>{@link pythonpipeline.impl.OutputFileImpl#getName <em>Name</em>}</li>
 *   <li>{@link pythonpipeline.impl.OutputFileImpl#getExport <em>Export</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OutputFileImpl extends EObjectImpl implements OutputFile {
	...
	protected EClass eStaticClass() {
		return PythonpipelinePackage.Literals.OUTPUT_FILE;
	}
	...
	public void setFileFormat(Format newFileFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.OUTPUT_FILE__FILE_FORMAT, oldFileFormat, fileFormat));
	}
	...
	public void setStoragePath(String newStoragePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.OUTPUT_FILE__STORAGE_PATH, oldStoragePath, storagePath));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.OUTPUT_FILE__NAME, oldName, name));
	}
	...
	public Export getExport() {
		if (export != null && export.eIsProxy()) {
			...
			if (export != oldExport) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PythonpipelinePackage.OUTPUT_FILE__EXPORT, oldExport, export));
			}
		}
		return export;
	}
	...
	public NotificationChain basicSetExport(Export newExport, NotificationChain msgs) {
		...
		export = newExport;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.OUTPUT_FILE__EXPORT, oldExport, newExport);
	...
	public void setExport(Export newExport) {
		if (newExport != export) {
			...
			if (export != null)
				msgs = ((InternalEObject)export).eInverseRemove(this, PythonpipelinePackage.EXPORT__WRITES, Export.class, msgs);
			if (newExport != null)
				msgs = ((InternalEObject)newExport).eInverseAdd(this, PythonpipelinePackage.EXPORT__WRITES, Export.class, msgs);
			msgs = basicSetExport(newExport, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.OUTPUT_FILE__EXPORT, newExport, newExport));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PythonpipelinePackage.OUTPUT_FILE__EXPORT:
				if (export != null)
					msgs = ((InternalEObject)export).eInverseRemove(this, PythonpipelinePackage.EXPORT__WRITES, Export.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PythonpipelinePackage.OUTPUT_FILE__FILE_FORMAT:
				return getFileFormat();
			case PythonpipelinePackage.OUTPUT_FILE__STORAGE_PATH:
				return getStoragePath();
			case PythonpipelinePackage.OUTPUT_FILE__NAME:
				return getName();
			case PythonpipelinePackage.OUTPUT_FILE__EXPORT:
