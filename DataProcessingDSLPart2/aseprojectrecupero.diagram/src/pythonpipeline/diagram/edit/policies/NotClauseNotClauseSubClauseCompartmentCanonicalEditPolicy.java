...
public class NotClauseNotClauseSubClauseCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getNotClauseNotClauseSubClauseCompartment_7034SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PythonpipelineNodeDescriptor> childDescriptors = PythonpipelineDiagramUpdater
				.getNotClauseNotClauseSubClauseCompartment_7034SemanticChildren((View) getHost().getModel());
