 ...
 * @generated
 */
public class ChangeDataFormatIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ChangeDataFormatIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineprojectParserProvider.getParser(PipelineprojectElementTypes.ChangeDataFormat_2052,
					getParserElement(), PipelineprojectVisualIDRegistry
							.getType(pipelineproject.diagram.edit.parts.ChangeDataFormatIdEditPart.VISUAL_ID));
		}
		return parser;
	}
