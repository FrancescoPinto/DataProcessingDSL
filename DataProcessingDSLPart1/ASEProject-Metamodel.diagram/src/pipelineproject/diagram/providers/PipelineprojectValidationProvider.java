 ...
 * @generated
 */
public class PipelineprojectValidationProvider {
	...
	public static void runWithConstraints(TransactionalEditingDomain editingDomain, Runnable operation) {
		...
		if (editingDomain != null) {
			try {
				...
				PipelineprojectDiagramEditorPlugin.getInstance().logError("Validation failed", e); //$NON-NLS-1$
			}
		} else {
			task.run();
		}
	...
	static boolean isInDefaultEditorContext(Object object) {
		...
		if (object instanceof View) {
			return constraintsActive
					&& PipelineEditPart.MODEL_ID.equals(PipelineprojectVisualIDRegistry.getModelID((View) object));
		}
		return true;
	}
