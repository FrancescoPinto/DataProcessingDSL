...
public class AttributeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PythonpipelineParserProvider.getParser(PythonpipelineElementTypes.Attribute_3033,
					getParserElement(), PythonpipelineVisualIDRegistry
							.getType(pythonpipeline.diagram.edit.parts.AttributeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
