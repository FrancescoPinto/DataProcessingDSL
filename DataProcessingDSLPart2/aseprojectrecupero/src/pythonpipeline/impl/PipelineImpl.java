 ...
 * </p>
 * <ul>
 *   <li>{@link pythonpipeline.impl.PipelineImpl#getTasks <em>Tasks</em>}</li>
 *   <li>{@link pythonpipeline.impl.PipelineImpl#getDataFlows <em>Data Flows</em>}</li>
 *   <li>{@link pythonpipeline.impl.PipelineImpl#getSchema <em>Schema</em>}</li>
 *   <li>{@link pythonpipeline.impl.PipelineImpl#getOutputFile <em>Output File</em>}</li>
 *   <li>{@link pythonpipeline.impl.PipelineImpl#getPipelineName <em>Pipeline Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PipelineImpl extends EObjectImpl implements Pipeline {
	...
	protected EClass eStaticClass() {
		return PythonpipelinePackage.Literals.PIPELINE;
	}
	...
	public EList<Task> getTasks() {
		if (tasks == null) {
			tasks = new EObjectContainmentEList<Task>(Task.class, this, PythonpipelinePackage.PIPELINE__TASKS);
		}
		return tasks;
	}
	...
	public EList<DataFlow> getDataFlows() {
		if (dataFlows == null) {
			dataFlows = new EObjectContainmentEList<DataFlow>(DataFlow.class, this, PythonpipelinePackage.PIPELINE__DATA_FLOWS);
		}
		return dataFlows;
	}
	...
	public EList<Schema> getSchema() {
		if (schema == null) {
			schema = new EObjectContainmentEList<Schema>(Schema.class, this, PythonpipelinePackage.PIPELINE__SCHEMA);
		}
		return schema;
	}
	...
	public EList<OutputFile> getOutputFile() {
		if (outputFile == null) {
			outputFile = new EObjectContainmentEList<OutputFile>(OutputFile.class, this, PythonpipelinePackage.PIPELINE__OUTPUT_FILE);
		}
		return outputFile;
	}
	...
	public void setPipelineName(String newPipelineName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PythonpipelinePackage.PIPELINE__PIPELINE_NAME, oldPipelineName, pipelineName));
	}
