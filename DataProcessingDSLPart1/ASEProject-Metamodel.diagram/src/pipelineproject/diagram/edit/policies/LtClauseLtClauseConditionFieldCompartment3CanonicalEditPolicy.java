 ...
 * @generated
 */
public class LtClauseLtClauseConditionFieldCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getLtClauseLtClauseConditionFieldCompartment_7119SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getLtClauseLtClauseConditionFieldCompartment_7119SemanticChildren((View) getHost().getModel());
