 ...
 * @generated
 */
public class LtClauseLtClauseConditionFieldCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getLtClauseLtClauseConditionFieldCompartment_7102SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineprojectNodeDescriptor> childDescriptors = PipelineprojectDiagramUpdater
				.getLtClauseLtClauseConditionFieldCompartment_7102SemanticChildren((View) getHost().getModel());
