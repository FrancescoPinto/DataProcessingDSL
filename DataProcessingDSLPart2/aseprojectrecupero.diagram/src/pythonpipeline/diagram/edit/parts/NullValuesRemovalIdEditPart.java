...
public class NullValuesRemovalIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PythonpipelineParserProvider.getParser(PythonpipelineElementTypes.NullValuesRemoval_2014,
					getParserElement(), PythonpipelineVisualIDRegistry
							.getType(pythonpipeline.diagram.edit.parts.NullValuesRemovalIdEditPart.VISUAL_ID));
		}
		return parser;
	}
