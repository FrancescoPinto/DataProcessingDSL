 ...
 * @generated
 */
public class DataFlowCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public DataFlowCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return PipelineprojectBaseItemSemanticEditPolicy.getLinkConstraints().canCreateDataFlow_4007(getContainer(),
				getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		DataFlow newElement = PipelineprojectFactory.eINSTANCE.createDataFlow();
		getContainer().getDataFlows().add(newElement);
	...
	* @generated
	*/
	protected void doConfigure(DataFlow newElement, IProgressMonitor monitor, IAdaptable info)
