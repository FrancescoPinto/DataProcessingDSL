...
import pipelineproject.diagram.edit.policies.AndClauseAndClauseOperandsCompartment3CanonicalEditPolicy;
import pipelineproject.diagram.edit.policies.AndClauseAndClauseOperandsCompartment3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AndClauseAndClauseOperandsCompartment3EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public AndClauseAndClauseOperandsCompartment3EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.AndClauseAndClauseOperandsCompartment3EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AndClauseAndClauseOperandsCompartment3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(PipelineprojectVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AndClauseAndClauseOperandsCompartment3CanonicalEditPolicy());
	}
